...
var mob = preload("res://Customer.tscn")
...
var coinThreshold = 40
func _ready():
	# Instantiate the CountdownTimer and pass the coinThreshold value
	var countdown_timer1 = preload("res://countdown_1.tscn").instantiate()
	countdown_timer1.coinThreshold = coinThreshold  # Pass the coinThreshold value
	add_child(countdown_timer1)
